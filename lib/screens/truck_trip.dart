...
import 'package:haulier_track_app/screens/truck_sched.dart'; // Update the import as needed

class TruckTripScreen extends StatefulWidget {
  final Function(TruckTrip) onTripUpdated;
  final List<TruckTrip> truckTrips;

  TruckTripScreen({required this.onTripUpdated, required this.truckTrips});
