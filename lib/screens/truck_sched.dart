...
class _DashboardScreenState extends State<DashboardScreen> {
      ...
      body: Container(
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage("assets/images/background_image.jpg"),  // Replace with your image asset path
            fit: BoxFit.cover,
          ),
        ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Date: ${trips[index].date}, ${trips[index].time.format(context)}'),
  ...
  void _startEditing(TruckTrip trip) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => TruckTripScreen(onTripUpdated: _handleTripUpdated, truckTrips: []),
      ),
    );
  }
